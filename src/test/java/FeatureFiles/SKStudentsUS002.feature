Feature:SKAcademics006-010
  Scenario: Functionality of the Course Schedule under Academics on the left pane
  ...
  Scenario: Verifying the Course Schedule link
    Given User navigates the Academics page
    When User clicks the link text of Course Schedule
    Then User should navigate to page "<urlCourseSchedule>"


  Scenario: Functionality of the Degree Programs under Academics on the left pane
    Given User navigates the Academics page
  ...
  Scenario: Verifying the Degree Programs link
    Given User navigates the Academics page
    When User clicks the link text of Degree Programs
    Then User should navigate to page "<urlDegreePrograms>"


  Scenario: Functionality of the Calendar of Events under Academics on the left pane
    Given User navigates the Academics page
  ...
  Scenario: Verifying the Calendar of Events link
    Given User navigates the Calendar of Events page
    When User clicks the link text of Calendar of Events
    Then User should navigate to page "<urlCalendarofEvents>"
...
#    And User should navigate to page
#
#  Scenario: Functionality of the links under Academics on the left pane
#    Given User navigates the Academics page
